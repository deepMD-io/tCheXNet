...
csv_file_path = 'chexnet_chexpert_valid_frontal_6_classes_Pneumothorax_prediction_score.csv'
y_score_chexnet = read_y_score_csv_file(csv_file_path)
y_score_chexnet = np.asarray(y_score_chexnet)

csv_file_path = 'tchexnet_chexpert_valid_frontal_6_classes_Pneumothorax_prediction_score.csv'
